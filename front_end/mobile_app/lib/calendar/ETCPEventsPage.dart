  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Map<String, dynamic>>>(
        future: _calendarService.fetchUserEventsByType(currentUser!.uid, 'ETC'),
        builder: (context, snapshot) {
          if (snapshot.connectionState == ConnectionState.waiting) {
            ...
            return Center(child: Text('No ETC events found'));
          } else {
            List<Map<String, dynamic>> ETCEvents = snapshot.data!;
